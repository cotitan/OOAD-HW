...
public class MovieController {
	...
	public @ResponseBody ArrayList<Movie> returnMovieList() {
        ...
        Movie m1 = new Movie("疯狂动物城", m1_intro, avatar1);
        Movie m2 = new Movie("愤怒的小鸟", m2_intro, avatar1);
        ArrayList<Movie> list_ = new ArrayList<Movie>();
        list_.add(m1);
		return list_;
	}
